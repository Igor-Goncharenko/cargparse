...
#define STATIC_ASSERT(_cond, _msg) typedef char _static_assert##_msg[(_cond) ? 1 : -1] __attribute__((unused))
...
#define TEST_IS_NULL(_a) TEST((_a) == NULL)

#define TEST_IS_NOT_NULL(_a) TEST((_a) != NULL)
